  ...
  <head>
    ...
    <script type="text/javascript" src="http://cdn.jsdelivr.net/jquery/2.0.2/jquery.min.js"></script>
            ...
            <div class="col-sm-7 col-sm-offset-1">
              <div class="form-group">
                ...
                <script>
                    ...
                    CKEDITOR.replace('knowledge_desc', {language: 'en'});
                </script>
              </div>
            </div>
            <div class="col-sm-3">
            ...
            <div class="col-sm-7 col-sm-offset-1">
              <div class="form-group">
                ...
                <script>
                    // Replace the <textarea id="editor1"> with a CKEditor
                    // instance, using default configuration.
                    CKEDITOR.replace('knowledge_item_desc', {language: 'en'});
                </script>
              </div>
            </div>
            <div class="col-sm-3">
            ...
            <div class="col-sm-7">
              <div class="form-group">
                ...
                <script>
                    // Replace the <textarea id="editor1"> with a CKEditor
                    // instance, using default configuration.
                    CKEDITOR.replace('knowledge_item_desc_tem', {language: 'en'});
                </script>
              </div>
            </div>
